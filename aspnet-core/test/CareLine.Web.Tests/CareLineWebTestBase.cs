...
using CareLine.Models.TokenAuth;
...
{
    public abstract class CareLineWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CareLineWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CareLineWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CareLineDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CareLineDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CareLineDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CareLineDbContext, Task<T>> func)
        {
            T result;
